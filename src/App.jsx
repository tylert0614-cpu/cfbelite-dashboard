    ...
    <style>{`
      ...
      * { box-sizing: border-box; }
      ...
      @media (max-width:760px) {
        ...
        .network-channel-list em { position:static!important;display:block!important;color:#fbbf24;font-size:7px; }
