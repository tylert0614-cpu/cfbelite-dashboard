  ...
  return (
    <style>{`
      ...
      * { box-sizing: border-box; }
      ...
      .newsroom-story-meta { display:flex;align-items:center;gap:9px;color:#8f9caf;font-size:9px;text-transform:uppercase;letter-spacing:.1em; }.newsroom-story-meta b { color:#9cc3d1; }.newsroom-story-meta em { margin-left:auto;padding:4px 6px;border-radius:999px;color:#c9d0d9;background:rgba(201,208,217,.08);font-style:normal;font-weight:1000; }
      ...
      .network-kickoff-form{display:flex!important;gap:8px!important;align-items:center!important}
      .network-kickoff-form input{padding:8px 10px!important;border:1px solid rgba(255,255,255,.16)!important;border-radius:7px!important;background:#0d1420!important;color:#e5e7eb!important;font-size:12px!important}
`}</style>
  );
}
